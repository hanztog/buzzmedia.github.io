                        ...
                        <div class="box-body">
                            <div class="form-horizontal">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="select2 form-control" name="nama_matapelajaran" required="">
                                            ...
                                            <?php foreach ($kelas as $a) { ?>
                                                <option value="<?= $a->id_matapelajaran ?>" <?php if ($s->nama_matapelajaran == $a->nama_matapelajaran) {
                                                                                                echo "selected='selected'";
                                                                                            } ?>><?= $a->kode_matapelajaran; ?> | <?= $a->nama_matapelajaran; ?></option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="soal" class="" id="soal" required><?= $s->pertanyaan; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
