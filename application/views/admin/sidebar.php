    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="<?= base_url('image/logo.png') ?>" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if ($this->session->userdata('status') == 'admin_login') { ?>
          ...
          <li <?= $this->uri->segment(1) == 'guru' ? 'class="active"' : '' ?>>
            <a href="<?php echo base_url('guru'); ?>"><i class="fa fa-circle-o"></i> Data Admin</a>
          </li>
          <li <?= $this->uri->segment(1) == 'siswa' ? 'class="active"' : '' ?>>
            <a href="<?php echo base_url('siswa'); ?>"><i class="fa fa-circle-o"></i> Data Pengguna</a>
          </li>
          <li <?= $this->uri->segment(1) == 'soal_ujian' ? 'class="active"' : '' ?>>
            <a href="<?php echo base_url('soal_ujian'); ?>"><i class="fa fa-circle-o"></i> Kelola Soal</a>
          </li>
          <li <?= $this->uri->segment(1) == 'peserta' ? 'class="active"' : '' ?>>
            <a href="<?php echo base_url('peserta'); ?>"><i class="fa fa-circle-o"></i> Kelola Pengguna</a>
          </li>
          <li <?= $this->uri->segment(1) == 'hasil_ujian' ? 'class="active"' : '' ?>>
            <a href="<?php echo base_url('hasil_ujian'); ?>"><i class="fa fa-circle-o"></i> Hasil Pengguna</a>
          </li>
