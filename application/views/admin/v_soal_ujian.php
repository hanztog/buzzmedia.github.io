        ...
        <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="select2 form-control" name="id" required="">
                                    <option selected="selected" disabled="">- Pilih Tipe Soal-</option>
            ...
            <div class="box box-success" style="overflow-x: scroll;">
                <div class="box-header">
                    ...
                    <a href="<?php echo base_url('matapelajaran'); ?>"><button type="button" class="btn btn-primary btn-flat" data-toggle="modal" data-target="#"><span></span>Data Tipe Soal</button></a>
                </div>
