...
<section class="content">
    ...
    <div class="callout callout-warning">
        <h4>Selamat Datang, Bapak <?= $this->session->userdata('nama'); ?>, S.Kom</h4>
            ...
            <dl>
                ...
                <dd>
                    <ol>
                        ...
                        di TAB Kelola Soal Ujian, anda dapat melihat daftar soal ujian, dengan memfilter mata pelajaran apa yang ingin anda lihat. dan anda bisa menambah, edit, dan hapus soal ujian.
