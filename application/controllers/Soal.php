...
class Soal extends CI_Controller
{
	...
	public function insert()
	{
		...
		if ($nama_matapelajaran == '' || $soal == '') {
			$this->session->set_flashdata('message', '<div class="alert alert-danger alert-message alert-dismissible"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><h4><i class="icon fa fa-ban"></i> Maaf, Input Soal Gagal!</h4> Mata Pelajaran dan Soal tidak boleh dikosongkan.</div>');
